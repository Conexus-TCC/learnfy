...
if($buscaCpf->num_rows == 0 && $buscaEmail->num_rows == 0){
    ...
    $query = "INSERT INTO usuario (nome_usuario, data_nascimento, sexo, ddd, telefone, email, senha, cpf, foto, status) VALUES ('$nome', '$data_nascimento', '$sexo', '$ddd', '$telefone', '$email', '$senha', '$cpf', '$dir', $status)";
